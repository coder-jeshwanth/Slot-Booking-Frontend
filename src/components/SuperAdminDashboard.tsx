...
const SuperAdminDashboard = () => {
  ...
  const filteredSlots = slotList.filter(slot => {
    ...
    if (searchQuery) {
      ...
      const salesUserStr = Array.isArray(slot.assignedSalesUser) 
        ...
        : slot.assignedSalesUser.toLowerCase();
      const matchesSearch = 
  ...
  const handleCreateProject = () => {
    if (newProject.name && newProject.code && newProject.location && newProject.timezone) {
      ...
      setNewProject({ name: '', code: '', status: 'Active', location: '', timezone: '', projectAdmin: '' });
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  {availableProjectAdmins.map((admin, index) => (
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                <label>Project Admin</label>
                <select
                  value={editingProject.projectAdmin}
                  onChange={(e) => setEditingProject({ ...editingProject, projectAdmin: e.target.value })}
                >
                  <option value="">Select Project Admin</option>
                  {availableProjectAdmins.map((admin, index) => (
                    <option key={index} value={admin}>{admin}</option>
